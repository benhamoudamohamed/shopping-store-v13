...
export const EmailContact = async (subject: string, header: string, email: string, fullname: string, phone: string,
  formSubject: string, message: string) => {
                                ...
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                  <div style="color: #000000; line-height: 160%; word-wrap: break-word;">
                                    ...
                                    <p style="font-size: 14px; line-height: 160%;  text-align: left; margin-top: 10%;">
                                      <span style="font-size: 18px; line-height: 28.8px; ">Client Name: ${fullname}</span>
                                    </p>
                                  ...
                                  <p style="font-size: 14px; line-height: 160%; text-align: left;">
                                    <span style="font-size: 18px; line-height: 28.8px;">Subjec: ${formSubject}</span>
                                  </p>
                                  <span style="font-size: 18px; line-height: 28.8px;">Message: ${message}</span>
                                  </p>
                                  </div>
                                </td>
                              </tr>
